 ...
 * 图片管理页（学生演示项目）
 *
 * 三个页签：我的图片（上传、列表）、文搜图（关键词检索）、图搜图（选文件检索）。
  ...
  <div class="card ui-card">
    ...
    <header class="page-header">
      <div class="main-tabs">
        ...
        <!-- 图搜图：隐藏文件选择框 + 选择区（占位/文件名 + 图标）+ 搜索按钮 -->
